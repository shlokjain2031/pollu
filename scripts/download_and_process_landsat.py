...
and process them using landsat8_signals.py → raster_to_grid_df.
...
Usage:
  python scripts/download_and_process_landsat.py \\
...
# Import the raster_to_grid_df function from landsat8_signals
sys.path.insert(0, str(Path(__file__).parent.parent))
from patliputra.landsat8_signals import raster_to_grid_df
